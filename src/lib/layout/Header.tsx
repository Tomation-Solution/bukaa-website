...
const MemberLogin = () => {
  ...
  return (
    <a href={loginUrl} target="_blank" rel="noopener noreferrer">
      <Button fontWeight={600} size={{ base: "sm", md: "md", lg: "lg" }}>Member Login</Button>
    </a>
  );
};
...
export function Header() {
  ...
  return (
    <Flex direction={"column"} position={"fixed"} top={0} zIndex={50} w={"100vw"}>
      <Flex
        px={{ base: "4%", md: "3%", lg: "8%" }}
        py={"1rem"}
      ...
      >
        <Link href={"/"}>
          <Flex cursor={"pointer"} align={"center"} gap={{ base: "1rem", md: "3rem", lg: "5rem" }}>
            <Flex cursor={"pointer"} align={"center"} gap={"1rem"}>
              <Image src="/log.jpg" w={{ base: "35px", md: "40px" }} h={{ base: "35px", md: "40px" }} alt="" />
              <Text fontWeight={600} fontSize={{ base: "16px", md: "18px", lg: "20px" }} color={"secondary.main"}>
                BUKAA
              </Text>
            </Flex>
            <Show above="md">
              <Flex  gap={["1rem", "1rem", "0.3rem", "0.4rem", "1rem"]} align={"center"} fontWeight="500" color={"secondary.main"} fontSize={{ base: "15px", md: "12px", lg: "15px" }}>
        ...
        <Flex gap={{ base: "1.5rem", md: "1rem", lg: "2rem" }} align={"center"} fontWeight="500" color={"secondary.main"}>
          <Show above="md">
